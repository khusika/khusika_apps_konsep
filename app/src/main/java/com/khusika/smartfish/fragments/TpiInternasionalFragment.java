...
public class TpiInternasionalFragment extends Fragment {
    public static TpiInternasionalFragment newInstance() {
        TpiInternasionalFragment fff = new TpiInternasionalFragment();
        return fff;
    }
